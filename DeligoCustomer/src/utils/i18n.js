...
export const translations = {
  en: {
    ...
    pleaseSelectVariation: "Please select an option to continue",
    ...
    orderWillAppearInOrders: "You can track this order anytime from Orders.",
    ...
    maxAddressesReached:
      "You have reached the maximum number of delivery addresses. Please delete an existing address to add a new one.",
    ...
    needHelp: "Need Help?",
    contactSupportText:
      "If you have trouble finding your location, please contact support.",
    verified: "Verified",
    ...
    addFavoritesHint:
      "Save your favorite restaurants to order quickly next time!",
    ...
    howTrackOrderAnswer:
      "You can track your order in real-time by going to the 'Orders' tab and selecting your active order.",
    deliveryCharges: "What are the delivery charges?",
    deliveryChargesAnswer:
      "Delivery fees vary based on your distance from the restaurant. The exact fee is shown at checkout.",
    applyVoucherQuestion: "How do I apply a voucher?",
    applyVoucherAnswer:
      "You can apply a voucher code at the checkout screen before making a payment.",
    cancelOrder: "Cancel Order",
    cancelOrderAnswer:
      "You can cancel an order within a few minutes of placing it, provided the restaurant hasn't started preparing it yet.",
    ...
    logout: "Logout",
    referralMessage:
      "Join DeliGo and get €100 off on your first order! Use my referral code: {code}",
    ...
    // Network & Connection
    network_error_title: "Connection Lost",
    network_error_msg:
    ...
    termsIntro:
      "By using our app, you agree to the following terms. Please read them carefully.",
    useOfService: "1. Use of Service",
    useOfServiceText:
      "You agree to use DeliGo only for lawful purposes and in accordance with these terms.",
    userAccounts: "2. User Accounts",
    userAccountsText:
      "You are responsible for maintaining the confidentiality of your account and password.",
    ordersPayments: "3. Orders and Payments",
    ordersPaymentsText:
      "All orders are subject to acceptance and availability. Payments must be made through approved methods.",
    ...
    dataCollectionText:
      "We collect information you provide when using DeliGo, such as your name, email, and order details.",
    dataUsage: "2. Data Usage",
    dataUsageText:
      "Your data is used to provide and improve our services, process orders, and communicate with you.",
    dataSharing: "3. Data Sharing",
    dataSharingText:
      "We do not sell your data. We may share it with partners only to fulfill your orders or comply with the law.",
    security: "4. Security",
    securityText:
    ...
    permissions: {
      ...
      locationDescription:
        "We need your location to show nearby restaurants and track your delivery.",
      notificationsTitle: "Notifications",
      notificationsDescription:
        "Get real-time updates on your order status and exclusive offers.",
      allowLocation: "Allow Location",
      locationRequired: "Location Required",
      allowNotifications: "Allow Notifications",
      notificationsOptional: "Notifications Optional",
      notificationsSkipMessage:
  ...
  pt: {
    ...
    what_on_your_mind: "Em que está a pensar?",
    ...
    pleaseSelectVariation: "Por favor, selecione uma opção para continuar",
    ...
    clearCartConfirm:
      "O seu carrinho contém itens de outro restaurante. Deseja limpá-lo e adicionar este item?",
    ...
    deliveryInstructionsPlaceholder:
      "p.ex., Deixar na porta, Tocar duas vezes...",
    ...
    contactSupportText:
      "Se tiver dificuldades em encontrar a sua localização, por favor contacte o suporte.",
    verified: "Verificado",
    ...
    maxAddressesReached:
      "Atingiu o número máximo de moradas de entrega. Por favor, elimine uma morada existente para adicionar uma nova.",
    ...
    chat: "Chat",
    chatFeatureText:
      "A funcionalidade de chat abrirá aqui.\n\nPode enviar:\n• Onde está?\n• Por favor, despache-se\n• Deixe na porta\n• Ligue quando chegar",
    ...
    addFavoritesHint:
      "Guarde os seus restaurantes favoritos para pedir rapidamente na próxima vez!",
    exploreRestaurants: "Explorar Restaurantes",
    lockedFeatureTitle: "Desbloquear Recursos Exclusivos",
    lockedFeatureMessage:
      "Use o aplicativo regularmente e faça mais pedidos para desbloquear e aproveitar esses recursos exclusivos.",
    notifications: "Notificações",
    deleteAccountMessage: "Por favor contacte o suporte.",
    noNotifications: "Sem Notificações",
    noNotificationsDesc:
      "Está tudo em dia! Volte mais tarde para ver atualizações.",
    ...
    howTrackOrderAnswer:
      "Pode acompanhar o seu pedido em tempo real indo ao separador 'Pedidos' e selecionando o seu pedido ativo.",
    deliveryCharges: "Quais são as taxas de entrega?",
    deliveryChargesAnswer:
      "As taxas de entrega variam consoante a sua distância do restaurante. A taxa exata é mostrada no checkout.",
    applyVoucherQuestion: "Como aplico um voucher?",
    applyVoucherAnswer:
      "Pode aplicar um código de voucher no ecrã de checkout antes de efetuar o pagamento.",
    cancelOrder: "Cancelar Pedido",
    cancelOrderAnswer:
      "Pode cancelar um pedido dentro de alguns minutos após a realização, desde que o restaurante ainda não tenha começado a prepará-lo.",
    logout: "Sair",
    referralMessage:
      "Entre no DeliGo e ganhe €100 de desconto no primeiro pedido! Use meu código: {code}",
    ...
    permissions: {
      ...
      introDescription:
        "Para lhe oferecer a melhor experiência, precisamos de algumas permissões.",
      locationTitle: "Acesso à Localização",
      locationDescription:
        "Precisamos da sua localização para mostrar restaurantes próximos e acompanhar a entrega.",
      notificationsTitle: "Notificações",
      notificationsDescription:
        "Receba atualizações em tempo real sobre o estado do seu pedido e ofertas exclusivas.",
      ...
      notificationsSkipMessage:
        "Pode ativar as notificações mais tarde nas definições.",
    },
    common: {
    ...
    cameraPermissionRequired:
      "É necessária permissão da câmara para tirar fotos.",
    mediaPermissionDenied: "Permissão Negada",
    mediaPermissionRequired:
      "É necessária permissão da galeria para selecionar fotos.",
    failedToTakePhoto: "Falha ao tirar foto. Por favor, tente novamente.",
    failedToSelectPhoto:
      "Falha ao selecionar foto. Por favor, tente novamente.",
    locationPermissionDenied: "Permissão Negada",
    locationPermissionRequired:
      "É necessária permissão de localização para obter a localização atual.",
    failedToGetLocation: "Falha ao obter a localização atual.",
    googleMapsKeyMissing: "Chave da API do Google Maps não configurada",
    noPlacesFound:
      "Nenhum local encontrado. Por favor, tente uma pesquisa diferente.",
    addressSearchFailed:
      "Falha ao pesquisar o endereço. Por favor, tente novamente.",
    ...
    termsIntro:
      "Ao usar a nossa aplicação, concorda com os seguintes termos. Por favor, leia-os atentamente.",
    useOfService: "1. Uso do Serviço",
    useOfServiceText:
      "Você concorda em usar o DeliGo apenas para fins legais e de acordo com estes termos.",
    userAccounts: "2. Contas de Utilizador",
    userAccountsText:
      "Você é responsável por manter a confidencialidade de sua conta e senha.",
    ordersPayments: "3. Encomendas e Pagamentos",
    ordersPaymentsText:
      "Todas as encomendas estão sujeitas a aceitação e disponibilidade.",
    ...
    privacyIntro:
      "Valorizamos a sua privacidade e estamos empenhados em proteger as suas informações pessoais.",
    ...
    dataCollectionText:
      "Coletamos informações que você fornece ao usar o DeliGo.",
    dataUsage: "2. Uso de Dados",
    dataUsageText:
      "Seus dados são usados para fornecer e melhorar nossos serviços.",
    dataSharing: "3. Compartilhamento de Dados",
    dataSharingText: "Não vendemos seus dados.",
    security: "4. Segurança",
    securityText:
      "Usamos medidas de segurança padrão da indústria para proteger seus dados.",
    privacyContactUs: "5. Contate-nos",
    privacyContactUsText:
      "Para perguntas sobre privacidade, entre em contato com privacy@deligo.com.",
    ...
    otpSentEmail:
      "OTP enviado para o seu e-mail. Por favor verifique para entrar.",
    ...
    // Network & Connection
    network_error_title: "Ligação Perdida",
    network_error_msg:
      "Estamos com dificuldades em ligar aos nossos servidores. Por favor, verifique a sua internet e tente novamente.",
    retry_again: "Tentar Novamente",
    ...
    resetPasswordAnswer:
      "Pode redefinir a sua palavra-passe indo ao ecrã de Login e clicando em 'Esqueci-me da palavra-passe'.",
    changeEmailQuestion: "Posso alterar o meu endereço de email?",
    changeEmailAnswer:
      "Atualmente, não pode alterar o seu email registado diretamente na app. Por favor contacte o suporte.",
    ...
    updateProfileAnswer:
      "Pode atualizar o seu nome e número de telemóvel na secção 'Editar Perfil'.",
    ...
    orderWillAppearInOrders: "Pode acompanhar este pedido a qualquer momento em Pedidos.",
