...
export const translations = {
  ...
  pt: {
    ...
    ordersPaymentsText: 'Todos os pedidos estão sujeitos a aceitação e disponibilidade.',
    ...
    validMobileNumber: 'Por favor, digite um número de celular válido',
    validEmailAddress: 'Por favor, digite um email válido',
    otpSent: 'OTP Enviado',
    checkOTP: 'Por favor, verifique seu SMS/email para o código OTP',
    notRegistered: 'Não Registrado',
    accountNotRegistered: 'Conta não registrada. Por favor, contate o suporte.',
    enterOTP: 'Por favor, digite o OTP',
