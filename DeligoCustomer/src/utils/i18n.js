...
export const translations = {
  en: {
    ...
    logout: 'Logout',
    referralMessage: 'Join DeliGo Customer and get €100 off on your first order! Use my referral code: {code}',
    ...
    welcomeToDeligo: 'Welcome to DeliGo Customer',
    termsIntro: 'By using our app, you agree to the following terms. Please read them carefully.',
    useOfService: '1. Use of Service',
    useOfServiceText: 'You agree to use DeliGo Customer only for lawful purposes and in accordance with these terms.',
    ...
    dataCollectionText: 'We collect information you provide when using DeliGo Customer, such as your name, email, and order details.',
    ...
    // Permissions Screen
    permissions: {
      introTitle: 'Welcome to DeliGo Customer',
  ...
  pt: {
    ...
    logout: 'Sair',
    referralMessage: 'Entre no DeliGo Customer e ganhe €100 de desconto no primeiro pedido! Use meu código: {code}',
    ...
    // Permissions Screen
    permissions: {
      introTitle: 'Bem-vindo ao DeliGo Customer',
